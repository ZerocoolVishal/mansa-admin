...
<div class="blogs-form">
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'blog_category_id')->dropDownList(\app\helpers\AppHelpers::getBlogCategories(), ['prompt' => 'Select Category']) ?>
                </div>

                <div class="col-md-6">
                    <?= $form->field($model, 'author_id')->dropDownList(\app\helpers\AppHelpers::getBlogAuthors(), ['prompt' => 'Select Author']) ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col col-md-12">
                    ...
                    <?php echo \dosamigos\fileupload\FileUpload::widget([
                        'name' => 'Blogs[image]',
                        'url' => [
                            'upload/common?attribute=Blogs[image]'
                        ],
                        'options' => [
                            'accept' => 'image/*',
                        ],
                        ...
                        'clientEvents' => [
                            ...
                            'fileuploaddone' => 'function (e, data) {
                                        if(data.result.files.error==""){
                                            ...
                                            $(".field-blogs-image input[type=hidden]").val(data.result.files.name);
