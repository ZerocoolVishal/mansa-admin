    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="fade-up">
                <div class="icon-box">
                    <div class="icon"><img src="https://i.ibb.co/SvRb6Nr/tea-bag.png" alt="tea-bag" border="0"></div>
                    <h4 class="title"><a href="">Detoxification and Deaddiction</a></h4>
                    <p class="description">Detoxification and Deaddiction ( alcohol, tobacco, charas, bhang, ganja, heroin,
                        cocaine, LSD, meth, brown sugar, inhalants etc.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="icon-box">
                    <div class="icon"><img src="https://i.ibb.co/DCXQR7x/care.png" alt="care" border="0"></div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                    <div class="icon"><img src="https://i.ibb.co/58mNd52/rehabilitation.png" alt="rehabilitation" border="0"></div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box">
                    <div class="icon"><img src="https://i.ibb.co/0cBPnT4/nursing-home.png" alt="nursing-home" border="0"></div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="icon-box">
                    <div class="icon"><img src="https://i.ibb.co/smG50P8/presentation.png" alt="presentation" border="0"></div>
