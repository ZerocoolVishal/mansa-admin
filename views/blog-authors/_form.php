...
<div class="blog-authors-form col-md-6">
            ...
            <div class="row">
                <div class="col col-md-12">
                    ...
                    <?php echo \dosamigos\fileupload\FileUpload::widget([
                        'name' => 'BlogAuthors[image]',
                        'url' => [
                            'upload/common?attribute=BlogAuthors[image]'
                        ],
                        'options' => [
                            'accept' => 'image/*',
                        ],
                        ...
                        'clientEvents' => [
                            ...
                            'fileuploaddone' => 'function (e, data) {
                                                if(data.result.files.error==""){
                                                    ...
                                                    $(".field-blogauthors-image input[type=hidden]").val(data.result.files.name);
